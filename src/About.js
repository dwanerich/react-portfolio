      ...
      <main class="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
        <div class="sm:text-center lg:text-left">
          ...
          <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
            ...
            <a href="https://drive.google.com/file/d/1qawunH63iFM9ScON1a_Kb8VgwGNiiS9C/view?usp=share_link" target="_blank" class="flex w-full items-center justify-center rounded-md border border-transparent bg-green-500 px-8 py-3 text-base font-medium text-white hover:border-black hover:bg-transparent hover:text-black md:py-4 md:px-10 md:text-lg">resume</a>
            </div>
